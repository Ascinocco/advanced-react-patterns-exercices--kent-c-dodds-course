...
class Toggle extends React.Component {
  ...
  internalSetState = (changes, callback) => {
    ...
    // this.setState((currState) => {
    //   const changesObj = typeof changes === 'function' ? changes(currState) : changes;
    //   const reducedChanges = this.props.stateReducer(currState, changesObj) || {};
    //   return Object.keys(reducedChanges).length ? reducedChanges : null; // this prevents re-render
    // }, callback)
  }
